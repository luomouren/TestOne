...
let pageSize = 10;
export default class HistoryDatas extends Component {
  // 构造
  constructor(props) {
    super(props);
  ...
  render() {
    return (
        <PullToRefreshListView
            ...
            contentContainerStyle={{backgroundColor: '#F5FCFF', }}//内容显示区域的背景颜色
            style={{}}
            initialListSize={20}
  ...
  _onRefresh = () => {
    ...
    setTimeout( () => {
      ...
      let uploadImageUrl = "http://192.168.0.104:8080/pwmana/itemsController/app/getHistoryVIResultList";
